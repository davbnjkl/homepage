...
function createInitialState(modeId = "standard", gameStarted = false, characterId = "tide") {
    return {
        ...
        dailyCatchCount: 0,
        dailySoldFishCount: 0,
        dailyCombineCount: 0,
        previousDailyCatchCount: 0,
        previousDailySoldFishCount: 0,
        previousDailyCombineCount: 0,
        dayStartCoinsBeforeIncome: INITIAL_COINS,
        nextFishingCostDiscount: 0,
        temporaryBaseDailyCoinCapMods: [],
        pondUpgradeDay: 0,
        activeEvents: [],
